...
Shader "Shader Forge/Char_Main_001_Building" {
    Properties {
        ...
        _node_5388 ("node_5388", Color) = (0.5,0.5,0.5,1)
...
////// Specular:
                ...
                float3 diffuseColor = (_node_5388.rgb*_Albedo_var.rgb); // Need this for specular when using metallic
...
////// Emissive:
                float3 emissive = _node_5388.rgb;
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                o.Emission = _node_5388.rgb;
                
                float4 _Albedo_var = tex2D(_Albedo,TRANSFORM_TEX(i.uv0, _Albedo));
                float3 diffColor = (_node_5388.rgb*_Albedo_var.rgb);
                float specularMonochrome;
                float3 specColor;
                float4 _metallic_var = tex2D(_metallic,TRANSFORM_TEX(i.uv0, _metallic));
