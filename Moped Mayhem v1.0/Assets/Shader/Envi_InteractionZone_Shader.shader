    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_912_ang = node_9120.g;
                ...
                clip(dot((1.0 - (node_8810.rgb*node_9430)),float3(0.3,0.59,0.11)) - 0.5);
////// Lighting:
////// Emissive:
                float4 node_782 = _Time + _TimeEditor;
                float node_4310 = (sin((node_782.g*_Puslespeed))*-0.5+0.5);
                float3 node_2598 = ((_Emissioncolor.rgb*_EmissionAmount)*clamp(node_4310,_DarkMin,_LightMax));
                float3 emissive = node_2598;
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_3679_tx = node_1543 - node_4915 * node_3679_ty;
                float2 node_3679 = (i.uv0 + float2(node_3679_tx, node_3679_ty)) * node_3679_tc_rcp;
                float4 node_5401 = _Time + _TimeEditor;
                float node_912_ang = node_5401.g;
                float node_912_spd = 1.0;
                float node_912_cos = cos(node_912_spd*node_912_ang);
                float node_912_sin = sin(node_912_spd*node_912_ang);
                float2 node_912_piv = float2(0.5,0.5);
