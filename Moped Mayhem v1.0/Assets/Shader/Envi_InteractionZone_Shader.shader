...
Shader "Shader Forge/Envi_InteractionZone_Shader" {
    Properties {
        ...
        _Barslider ("Bar slider", Range(0, 1)) = 0.4303466
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 node_6302 = _Time + _TimeEditor;
                float node_912_ang = node_6302.g;
                ...
                float node_9454 = 0.0;
                float node_9430 = (1.0 - saturate((node_9454 + ( (i.uv0.g - _Barslider) * (1.0 - node_9454) ) / ((0.0+_Barslider) - _Barslider))));
                clip((1.0 - (dot(node_8810.rgb,float3(0.3,0.59,0.11))*node_9430)) - 0.5);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_3679_tx = node_1543 - node_4915 * node_3679_ty;
                float2 node_3679 = (i.uv0 + float2(node_3679_tx, node_3679_ty)) * node_3679_tc_rcp;
                float4 node_4882 = _Time + _TimeEditor;
                float node_912_ang = node_4882.g;
                float node_912_spd = 1.0;
                float node_912_cos = cos(node_912_spd*node_912_ang);
                float node_912_sin = sin(node_912_spd*node_912_ang);
                float2 node_912_piv = float2(0.5,0.5);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_3679_tx = node_1543 - node_4915 * node_3679_ty;
                float2 node_3679 = (i.uv0 + float2(node_3679_tx, node_3679_ty)) * node_3679_tc_rcp;
                float4 node_2332 = _Time + _TimeEditor;
                float node_912_ang = node_2332.g;
                float node_912_spd = 1.0;
                float node_912_cos = cos(node_912_spd*node_912_ang);
                float node_912_sin = sin(node_912_spd*node_912_ang);
                float2 node_912_piv = float2(0.5,0.5);
